const Game = {
    ...
    drawAll() {
        ...
        if (this.player.score === 3) { this.winDoor.draw() }
    },
    ...
    checkPlayerEnemyCollision() {
        this.enemyArr.forEach((enemy, index, arr) => {
            ...
            // if (this.enemy.enemyPos.x > this.player.playerPos.x - 75 &&
            //     this.enemy.enemyPos.x - 25 < this.player.playerPos.x &&
            //     this.enemy.enemyPos.y > this.player.playerPos.y - 100 &&
            //     10 - this.enemy.enemyPos.y < this.player.playerPos.y) {
            //     alert('collision')
            // }